...
public class LodgeController extends Controller {
    ...
    private void getItemsInFields() {
        ...
        lodgeView.getTxtAccommodatieCode().setText((currentLodge.getAccommodatie_code()));
        ...
        lodgeView.getTxtAantalPersonen().setText((String.valueOf(currentLodge.getPersoon())));
